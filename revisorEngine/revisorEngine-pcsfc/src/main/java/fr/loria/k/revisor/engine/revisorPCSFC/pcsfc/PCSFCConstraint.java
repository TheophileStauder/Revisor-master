...
import fr.loria.k.revisor.engine.revisorPCSFC.pclc.RealVariable;
import fr.loria.k.revisor.engine.revisorPCSFC.pclc.Variable;
...
public class PCSFCConstraint extends PCSFCFormula {
	...
	public Formula toPCLC() {
		...
		Variable var = new RealVariable(left.toString());
		coefficients.put(var, new RationalNumber(7.));
		return new Constraint( coefficients, (RationalNumber) this.right.getNumber());
	}
